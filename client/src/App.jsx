  ...
  return (
    <div className="flex bg-[#0f0f0f] min-h-screen text-white">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 flex gap-6 overflow-auto">
          <Routes>
            <Route 
              path="/" 
              element={<Home videos={videos} onSelect={setSelectedVideo} />}
            /> 
            <Route path="/trending" element={<Trending />}/>
            <Route path="/subscriptions" element={<Subscriptions />}/>
            <Route
              ...
              element={
                <div className="flex-1 flex gap-6 p-6">
                  ...
                  <div className="w-[400px] flex-shrink-0">
                    <RecommendedList videos={videos} onSelect={setSelectedVideo} />
                  </div>
                </div>
              }
            />
